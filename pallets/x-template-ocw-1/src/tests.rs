...
fn should_submit_signed_transaction_on_chain() {
  ...
  SyncCryptoStore::sr25519_generate_new(&keystore, crate::crypto::Public::ID, Some(&format!("{}/hunter1", PHRASE))).unwrap();
...
fn should_submit_unsigned_transaction_on_chain_for_any_account() {
  ...
  t.execute_with(|| {
    ...
    }) = tx.call
    {
      ...
      let signature_valid =
        <PricePayload<<Test as SigningTypes>::Public, <Test as frame_system::Config>::BlockNumber> as SignedPayload<Test>>::verify::<
          crypto::TestAuthId,
