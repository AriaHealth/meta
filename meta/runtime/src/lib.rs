...
use sp_runtime::{
	...
	traits::{
		AccountIdLookup, BlakeTwo256, Block as BlockT, DispatchInfoOf, Dispatchable, Get, IdentifyAccount, NumberFor, PostDispatchInfoOf,
...
pub const MAXIMUM_BLOCK_WEIGHT: Weight = Weight::from_parts(2u64 * WEIGHT_REF_TIME_PER_SECOND, u64::MAX);
...
// Aria
impl pallet_tmp::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
}
